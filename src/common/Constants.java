	...
	public static TreeMap<Integer,SortStats> getStartSorts(int classID)
	{
		...
		switch(classID)
		{
			...
			case CLASS_SRAM:
				...
				start.put(72,World.data.getSort(72).getStatsByLevel(1));//Invisibilité
			...
			case CLASS_CRA:
				...
				start.put(164,World.data.getSort(164).getStatsByLevel(1));//Fleche Empoisonnée(ex Fleche chercheuse)
			break;
			case CLASS_IOP:
			...
			case CLASS_PANDAWA:
				...
				start.put(687,World.data.getSort(687).getStatsByLevel(1));//Poing enflammé
			break;
			case CLASS_ENUTROF:
				...
				start.put(41,World.data.getSort(41).getStatsByLevel(1));//Sac animé
			break;
			case CLASS_SACRIEUR:
				start.put(432,World.data.getSort(432).getStatsByLevel(1));//Pied du Sacrieur
				start.put(431,World.data.getSort(431).getStatsByLevel(1));//Chatiment Forcé
